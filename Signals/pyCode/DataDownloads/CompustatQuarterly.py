...
How to run: python3 CompustatQuarterly.py
"""
...
print("=" * 60, flush=True)
print(
    "📊 CompustatQuarterly.py - Compustat Quarterly Fundamentals",
    flush=True
)
print("=" * 60, flush=True)
...
print("=" * 60, flush=True)
print("✅ CompustatQuarterly.py completed successfully", flush=True)
print("=" * 60, flush=True)
