...
How to run: python3 CRSPDistributions.py
"""
...
print("=" * 60, flush=True)
print("💰 CRSPDistributions.py - CRSP Dividends & Distributions", flush=True)
print("=" * 60, flush=True)
...
print("=" * 60, flush=True)
print("✅ CRSPDistributions.py completed successfully", flush=True)
print("=" * 60, flush=True)