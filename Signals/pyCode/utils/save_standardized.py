# ABOUTME: save_standardized.py - saves predictor and placebo data in standardized CSV format 
...
Functions:
    - save_predictor: saves predictor data to pyData/Predictors/
    - save_placebo: saves placebo data to pyData/Placebos/

Inputs (both functions):
    - df: DataFrame with columns [permno, time_avail_m, predictor/placebo_name]
    - name: Name of the predictor/placebo column
    - output_dir: Output directory path (optional)

Outputs:
    - CSV file with columns [permno, yyyymm, predictor/placebo_name]
